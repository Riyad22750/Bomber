...
DEVELOPER : Heron Chowdhury 
GITHUB    : Riyad22750
VERSION   : 2.0
PROJECT   : SMS BOMBER 
FACEBOOK  : Heron Chowdhury
××××××××××××××××××××××××××××××××××××××××××××"""
  for i in logo:
    sys.stdout.write(i)
    sys.stdout.flush()
...
""")
  ...
  sys.exit()
baner= os.system("figlet -f slant HERON")
baner = str(baner)
baner = baner.replace("0","")
logo=f""" {baner} \033[1;37m
××××××××××××××××××××××××××××××××××××××××××××
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ DEVELOPER :Heron Chowdhury 
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ GITHUB    : Riyad22750
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ VERSION   : 2.0
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ PROJECT   : SMS BOMBING 
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ FACEBOOK  : Heron Chowdhury
××××××××××××××××××××××××××××××××××××××××××××"""
print(logo)
